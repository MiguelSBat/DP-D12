...
@Controller
@RequestMapping("/business/shippingInfo")
public class ShippingInfoBusinessController extends AbstractController {
	...
	public ShippingInfoBusinessController() {
		super();
	}
	...
	public ModelAndView save(@Valid final ShippingInfo shippingInfo, final BindingResult binding) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/business/ticket/display.do?ticketId=" + shippingInfo.getticket().getId());
