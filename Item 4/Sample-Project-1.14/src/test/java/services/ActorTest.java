...
public class ActorTest extends AbstractTest {
	...
	// Ancillary methods ------------------------------------------------------
	protected void createAndSaveTemplate(final String username, final String password, final String password2, final String name, final String surname, final String email, final String phone, final String authority, final Boolean agree,
